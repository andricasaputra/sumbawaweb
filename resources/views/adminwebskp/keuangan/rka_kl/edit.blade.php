...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content">
	  	...
	  	<form action="{{ route('rka_kl.update', $rka_kl->id) }}" method="post" enctype="multipart/form-data">
	  		...
	  		<div class="form-group">
	  			...
	  			<input type="number" name="tahun" class="form-control" value="{{ $rka_kl->tahun }}" min="0">
	  		</div>
	  		<div class="form-group">
	  			<label for="revisi">Revisi</label>
	  			<select name="revisi" class="form-control">
	  				<option>{{ $rka_kl->revisi }}</option>
	  				<option>Awal</option>
	  				<option>1</option>
	  				<option>2</option>
	  			</select>
