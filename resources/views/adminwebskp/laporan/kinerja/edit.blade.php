...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  <div class="x_title">
	    <a href="{{ route('kinerja.index') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
	  ...
	  <div class="x_content">
	  	...
	  	<form action="{{ route('kinerja.update', $kinerja->id) }}" method="post" enctype="multipart/form-data">
	  		...
	  		<div class="form-group">
	  			...
	  			<select name="jenis_laporan" class="form-control">
	  				<option>{{$kinerja->jenis_laporan}}</option>
	  		...
	  		<div class="form-group">
	  			...
	  			<input type="text" name="nama_laporan" class="form-control" value="{{$kinerja->nama_laporan}}">
	  		</div>
	  		<div class="form-group">
	  			<label for="tahun">Tahun</label>
	  			<input type="number" name="tahun" class="form-control" value="{{$kinerja->tahun}}" min="0">
	  		</div>
	  		<div class="form-group">
	  			<label for="file">Ubah File</label>
	  			<span>{{ $kinerja->file }}</span>
