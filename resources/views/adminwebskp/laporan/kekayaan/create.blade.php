...
@section('title', 'Tambah Laporan Harta Kekayaan Pejabat Negara')

@section('content')
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="page-title">
	  <div class="title_left">
	    <h3>Tambah Laporan Harta Kekayaan Pejabat Negara</h3>
	  </div>
	</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content">
	  	...
	  	<form action="{{ route('kekayaan.store') }}" method="post" enctype="multipart/form-data">
