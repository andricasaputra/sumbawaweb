...
@section('title', 'Edit Laporan PPID')

@section('content')
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="page-title">
	  <div class="title_left">
	    <h3>Edit Laporan PPID</h3>
	  </div>
	</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  <div class="x_title">
	    <a href="{{ route('ppid.index') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
	  	...
	  	<form action="{{ route('ppid.update', $ppid->id) }}" method="post" enctype="multipart/form-data">
	  		...
	  		<div class="form-group">
	  			...
	  			<select name="jenis_laporan" class="form-control">
	  				<option>{{$ppid->jenis_laporan}}</option>
	  		...
	  		<div class="form-group">
	  			...
	  			<input type="text" name="nama_laporan" class="form-control" value="{{$ppid->nama_laporan}}">
	  		</div>
	  		<div class="form-group">
	  			<label for="tahun">Tahun</label>
	  			<input type="number" name="tahun" class="form-control" value="{{$ppid->tahun}}" min="0">
	  		</div>
	  		<div class="form-group">
