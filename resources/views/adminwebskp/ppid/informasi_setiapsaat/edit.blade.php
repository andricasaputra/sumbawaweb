...
@section('title', 'Edit PPID Informasi Setiap Saat')

@section('content')
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="page-title">
	  <div class="title_left">
	    <h3>Edit PPID Informasi Setiap Saat</h3>
	  </div>
	</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content">
	  	...
	  	<form action="{{ route('informasi_setiapsaat.update', $informasi_setiapsaat->id) }}" method="post" enctype="multipart/form-data">
	  		...
	  		<div class="form-group">
	  			...
	  			<input type="text" name="nama_info" class="form-control" value="{{ $informasi_setiapsaat->nama_info }}">
	  		</div>
	  		<div class="form-group">
	  			<label for="bagian_info">Bagian Informasi</label>
	  			<select class="form-control" name="bagian_info" id="bagian_info">
	  				<option>{{ $informasi_setiapsaat->bagian_info }}</option>
	  		...
	  		<div class="form-group">
	  			...
	  			<select class="form-control" name="kategori" id="kategori">
	  				<option>{{ $informasi_setiapsaat->kategori }}</option>
	  				<option></option>
	  		...
	  		<div class="form-group">
	  			...
	  			<select class="form-control" name="keterangan" id="keterangan">
	  				<option>{{ $informasi_setiapsaat->keterangan }}</option>
	  				<option></option>
	  		...
	  		<div class="form-group">
	  			...
	  			<input type="text" name="link" class="form-control" value="{{ $informasi_setiapsaat->link }}" placeholder="kosongkan jika ada file yang akan diupload">
	  		</div>
	  		<div class="form-group">
	  			<label for="file">Upload File</label>
	  			<span>{{ $informasi_setiapsaat->file }}</span>
