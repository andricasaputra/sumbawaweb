...
@section('title', 'Tambah PPID Informasi Serta Merta')

@section('content')
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="page-title">
	  <div class="title_left">
	    <h3>Tambah Informasi Serta Merta</h3>
	  </div>
	</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content">
	  	...
	  	<form action="{{ route('informasi_sertamerta.store') }}" method="post" enctype="multipart/form-data">
